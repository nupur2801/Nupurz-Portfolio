...
const groups: Group[] = [
  {
    ...
    items: ["React", "Next.js", "JavaScript", "Tailwind CSS", "Vite"],
    accent: "sage",
    icon: <IconFrontend />,
  },
  {
  ...
  },
  {
    ...
    items: ["MongoDB", "Mongoose", "SQL", "Schema Design"],
    accent: "mustard",
    icon: <IconDatabase />,
  },
  {
    ...
    items: ["LLaMA 3", "Ollama", "Groq API", "Random Forest", "Prompt Engineering"],
    accent: "lilac",
    icon: <IconAI />,
  },
  {
    name: "cloud & iot",
    tagline: "deploying on azure & wiring up iot data streams",
    items: ["Azure", "AZ-900", "MQTT", "IoT Pipelines"],
    accent: "mint",
    icon: <IconCloud />,
  },
  {
